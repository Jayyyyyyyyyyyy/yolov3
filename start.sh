...
nohup python -m torch.distributed.launch --nproc_per_node 8 train.py --epochs 100 --batch 128 --imgsz 320 --data dataset.yaml --cfg models/yolov3-tiny.yaml --adam --single-cls --weights '' --device 0,1,2,3,4,5,6,7 --sync-bn --single-channel
